      ...
      <div class="row align-items-center">
        <div class="col-lg-12 mb-lg-30">
          <form method="POST">
            ...
            <div class="form-row">
              <div class="col-lg-12">
                <button type="submit" class="sigma_btn-custom d-block w-30 mx-auto" name="login"> Login <i class="far fa-arrow-right"></i> </button>
                <div class="text-center my-2">
                  <a href="register" style="margin-top:10px;">Belum punya akun?</a>
                </div>
              </div>
            </div>
          </form>
